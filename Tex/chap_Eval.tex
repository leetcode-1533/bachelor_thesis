...
\begin{itemize}
	...
	{
	\captionsetup{justification=centering}
	\includegraphics[width=0.3\textwidth]{Img/c4/seam_demo} \captionof{figure}{Seam Carver剔除示意}
	}
	\end{minipage}
	\medskip
	\end{center}
...
{
\captionsetup{justification=centering}
\includegraphics[width=\MyFactor\textwidth]{Img/c4/img_resize} \captionof{figure}{Image Interpolation 和 Seam Carver比较 \\ Seam Carver产生畸变的原因是它试图保留图片中变化剧烈的部分,如耳朵,嘴唇等.}
}
\end{minipage}
\medskip
\end{center}
